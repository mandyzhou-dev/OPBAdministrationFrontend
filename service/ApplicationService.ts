...
export const getApplicationHistory = async(query:ApplicationHistoryQuery):Promise<ApplicationHistoryPage>=>{
    const leaveApplicationRequest = new LeaveApplicationRequest()
    return leaveApplicationRequest.getApplicationHistory(query);
}
