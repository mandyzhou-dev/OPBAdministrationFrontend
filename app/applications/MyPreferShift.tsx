...
export default function MyPreferShift() {
    ...
    function getCanadianHolidays() {
        return [
          ...
          dayjs("2024-02-17"), //Family Day
          dayjs("2024-04-18"), // Good Friday
          dayjs("2024-05-19"), //Victoria Day
          dayjs("2024-07-01"), // Canada Day
          dayjs("2024-08-04"), //British Columbia Day
          dayjs("2024-09-01"), // Labour Day 
          dayjs("2024-09-30"), //National Day for Truth and Reconciliation
          dayjs("2024-10-13"), // Thanksgiving 
