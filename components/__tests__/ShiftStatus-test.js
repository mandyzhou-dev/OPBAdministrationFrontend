...
describe("ShiftStatus constants", () => {
  it("limits manual status actions to the approved shift statuses", () => {
  ...
  it("uses grey for no show/unpaid sick leave/personal leave and light purple for paid sick leave", () => {
  ...
  it("normalizes personal leave as a known shift status", () => {
    expect(normalizeShiftStatus("personal_leave")).toBe("personal_leave");
  });
